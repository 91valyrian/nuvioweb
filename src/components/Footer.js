  ...
  return (
    <footer className="footer relative pt-[120px] md:pt-[150px]">
      <div className="container footer-inner md:flex justify-between">
        ...
        <div className="flex flex-col items-center md:items-end gap-[20px] justify-center text-[36px] md:text-[24px] md:pr-[150px] text-center md:text-right mt-[50px] md:mt-0">
